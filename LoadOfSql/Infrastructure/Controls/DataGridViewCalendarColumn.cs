    ...
    class CalendarEditingControl : DateTimePicker, IDataGridViewEditingControl
    {
        ...
        public DateTime? NValue
        {
            ...
            set
            {
                ...
                try { t = (DateTime)val; this.Value = t; }
                catch (Exception) { }
                chType = 0;
            }
        }
        ...
        public CalendarEditingControl()
        {
           ...
           // this.ValueChanged += CalendarEditingControl_ValueChanged;
            this.TextChanged += CalendarEditingControl_TextChanged;
        }

        private void CalendarEditingControl_TextChanged(object sender, EventArgs e)
        {
            if (chType == 0)
                val = this.Value;
        }
